...
# 1. Преобразовать список запрошенных ролей во множество для мгновенного удаления дубликатов. 
unique_requested_roles = set(requested_roles)


# 2. Определить роли, которые одновременно присутствуют как в списке уникальных запрошенных, 
...
# 3. Вычислить недостающие административные роли, которые не были запрошены пользователем (разность множеств). 
missing_admin_roles = required_admin_roles - unique_requested_roles


# 4. Проверяить наличие роли security_officer в дедуплицированном множестве запрошенных ролей 
